...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        sans: ["Poppins", "Outfit", "Avenir", ...fontFamily.sans],
        questrial: "Questrial",
        manrope: ["Manrope", "sans-serif"],
        pockota: ["Pockota", "sans-serif"],
        aboro: ["var(--font-aboro)", "sans-serif"],
        "mona-sans": ["Mona Sans", "sans-serif"],
        macondo: ['Macondo"', "sans-serif"],
        lexend: ["Lexend", "sans-serif"],
        "astro-futuristic": ["Astro-Futuristic", "sans-serif"],
      },
      gridTemplateColumns: {
        "16-auto": "250px auto",
      },
  ...
  plugins: [
    ...
    plugin(function ({ addUtilities }) {
      const newUtilities = {
        ...
        ".shadow-light-fourSides": {
          boxShadow: "0 0 0.3rem 0.1rem rgba(0, 0, 0, 0.05)",
        },
        ".border-light": {
